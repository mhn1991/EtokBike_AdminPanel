...
class MobileConfigApiTest extends TestCase
{
    ...
    public function test_it_returns_products_from_the_database_for_the_shop_screen(): void
    {
        ...
        $this->getJson('/api/mobile/screens/shop')
            ...
            ->assertJsonPath('sections.0.type', 'product_list')
            ->assertJsonPath('sections.0.data.hideTitle', true)
            ->assertJsonPath('sections.0.data.defaultCategory', '')
            ->assertJsonPath('sections.0.data.quickFilterIds', ['availability', 'sort'])
            ->assertJsonPath('sections.0.data.categories.0.id', 'bikes')
            ->assertJsonPath('sections.0.data.categories.1.id', 'mountain-bikes')
            ->assertJsonPath('sections.0.data.categories.1.parentId', 'bikes')
            ->assertJsonPath('sections.0.data.categories.1.depth', 1)
            ->assertJsonPath('sections.0.data.items.0.id', 'bike-panel-test')
            ->assertJsonPath('sections.0.data.items.0.category', 'mountain-bikes')
            ->assertJsonPath('sections.0.data.items.0.categoryLabel', 'دوچرخه کوهستان')
            ->assertJsonPath('sections.0.data.items.0.categoryPath', ['bikes', 'mountain-bikes'])
            ->assertJsonPath('sections.0.data.items.0.title', 'دوچرخه پنل')
            ->assertJsonPath('sections.0.data.items.0.variants.0.name', 'قرمز / بزرگ')
            ->assertJsonPath('sections.0.data.items.0.variants.0.options.color', 'قرمز')
            ->assertJsonPath('sections.0.data.items.0.variants.0.stockQuantity', 3)
            ->assertJsonPath('sections.0.data.items.0.priceValue', 1230000)
            ->assertJsonPath('sections.0.data.items.0.isFeatured', false)
            ->assertJsonPath('sections.0.data.items.0.variants.0.priceValue', 1330000)
            ->assertJsonPath('sections.0.data.items.0.imageUrl', 'http://10.0.2.2:8001/storage/mobile/products/bike-panel-test.jpg')
            ->assertJsonPath('sections.0.data.filters.0.options.4.id', 'out_of_stock')
            ->assertJsonPath('sections.0.data.filters.1.options.3.id', 'newest')
            ->assertJsonPath('sections.0.data.filters.3.id', 'maxPrice')
            ->assertJsonPath('sections.0.data.filters.4.id', 'feature:color');
    }
