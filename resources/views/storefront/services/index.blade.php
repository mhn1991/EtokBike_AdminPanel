    ...
    <section class="storefront-page-hero">
        <div class="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
            <div class="self-center">
                <p class="storefront-eyebrow">تعمیرگاه و سرویس</p>
                <h1 class="mt-4 text-3xl font-extrabold leading-tight tracking-normal text-ink sm:text-5xl">دوچرخه‌تان را آماده مسیر نگه دارید</h1>
            ...
            <div class="storefront-surface-card p-5 sm:p-6">
                <p class="storefront-eyebrow">نوبت‌گیری آسان</p>
                <h2 class="mt-3 text-xl font-bold text-ink">زمان‌های فعال</h2>
                <div class="mt-4 grid gap-3">
                    @forelse ($timeSlots as $slot)
                        <div class="flex min-h-12 items-center justify-between rounded-xl border border-border bg-surface-alt px-4 py-3">
    ...
    <section class="bg-surface-page py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                <div>
                    <p class="storefront-eyebrow">انتخاب سرویس</p>
                    <h2 class="mt-3 text-2xl font-bold tracking-normal text-ink">خدمات قابل رزرو</h2>
    ...
    <section id="booking" class="bg-surface py-10">
        <div class="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
            <div>
                ...
                @if ($storeProfile)
                        <div class="storefront-surface-card mt-6 p-5">
            ...
            <form method="POST" action="{{ route('storefront.services.bookings.store') }}" class="storefront-form-card grid gap-5">
                @csrf
                ...
                <button type="submit" class="min-h-12 rounded-xl bg-brand px-6 text-sm font-bold text-white shadow-sm shadow-red-900/15 transition hover:bg-brand-hover focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2">ثبت درخواست سرویس</button>
            </form>
        </div>
    </section>
@endsection
